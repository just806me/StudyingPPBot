...
HELP_TEXT = '''Маленький хелп вам від мене. Я знаю чотири команди:
...
Хочешь побачити свої результати чи дізнатися список задач - /results тобі допоможе.
...
RESULTS_TEXT = "Гарні таблички з твоїми балами та списком задач можна знайти на сайті http://studying.codelabs.site/. Быльшість чисел це посилання, щоб було легше та швидше шукати"
